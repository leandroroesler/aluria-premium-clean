      ...
      <main className="min-h-screen bg-[#f8f5f1] px-6 py-20">
        <div className="mx-auto grid max-w-6xl gap-12 pt-10 lg:grid-cols-2">
          <div>
            ...
            <p className="mb-2 text-lg leading-relaxed text-neutral-600 text-justify">
            ...
            <p className="mb-2 text-lg leading-relaxed text-neutral-600 text-justify">
              ...
              Entre em contato conosco para descobrir como podemos ajudar a criar atmosferas únicas e experiências marcantes.
